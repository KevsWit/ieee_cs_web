...
HttpSession sesion = request.getSession();
 ...
 %>
		...
		String str_mem=request.getParameter("id_membresia");
		int id_mem=Integer.parseInt(str_mem);
		String desc=request.getParameter("descripcion");
		String str_costosm=request.getParameter("costo_sm");
  		double costo_sm = Double.parseDouble(str_costosm);
  		String str_costossm=request.getParameter("costo_ssm");
  		double costo_ssm = Double.parseDouble(str_costossm);
  		out.print(usr.ingresarMembresia(id_mem, desc, costo_sm, costo_ssm));
