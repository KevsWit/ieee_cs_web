...
<head>
	...
	<title>IEEE CS - Desarrolladores</title>
</head>
<body>
	<header>
		<div align="center">
		...
		<div style="height: auto;" class="center-content">
			...
			<aside style="color: black;">
				<h3 style="text-align: left;">Nombre</h3>
      			<div style="text-align: left;">Kevin Castillo</div>
      			<h3 style="text-align: left;">Edad</h3>
      			<div style="text-align: left;">21 años de edad</div>
      			<h3 style="text-align: left;">Correo</h3>
      			<div style="text-align: left;">kcastilloo1@est.ups.edu.ec</div>
      			<h3 style="text-align: left;">GitHub</h3>
      			<div style="text-align: left;"><a href="https://github.com/KevsWit">https://github.com/KevsWit</a></div>
			</aside>
		</div>
	</main>
