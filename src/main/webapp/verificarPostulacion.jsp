...
HttpSession sesion = request.getSession();
 ...
 %>
		...
		<%
			...
			String af = "Aficiones: " + request.getParameter("aficiones");
			String len = "Lenguajes de programación conocidos: " + request.getParameter("lenguajes");
			String info = af + "\n" + len;
			String directorio = request.getParameter("pdf");
			out.print(usr.ingresarPostulacion(usuario, info, directorio, "Seleccionada para revisión"));
