...
HttpSession sesion = request.getSession();
 ...
 %>
		...
		<div style="height: auto; border-radius: 10px;" class="center-content">
			...
			String str_eve=request.getParameter("id_evento");
			int id_eve=Integer.parseInt(str_eve);
			String desc=request.getParameter("descripcion");
			String str_tipo=request.getParameter("cmbTipo");
	  		int id_tipo=Integer.parseInt(str_tipo);
	  		out.print(eve.ingresarEvento(id_eve, desc, id_tipo));
			%>
		</div>
	</main>
